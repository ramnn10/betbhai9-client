        ...
        <div className='relative'>
            ...
            <div className={`relative ${LoadingBet ? 'opacity-50' : ''}`}>
                <div className='bg-gray-200'>
                    <div className="bg-[var(--primary)] text-white text-[14px] px-2 py-[6px] lg:rounded-t-[4px] flex justify-between">
                    ...
                    <div className={`${betSlipData.type === "No" ? "bg-[var(--matchKhai)]" : "bg-[var(--matchLagai)]"}`}>
                        <span className='flex justify-start items-center lg:hidden lg:px-0 px-4 pt-2 p w-full black-text text-[14px] font-medium capitalize'>
                        ...
                        <div className='grid xl:grid-cols-4 grid-cols-3 lg:pt-1 pt-2 gap-1 px-2'>
                            {myArray && myArray.length > 0 ? myArray.map((element, index) => (
                                <div key={index} className="px-0 cursor-pointer">
                                    <div className='lg:bg-gray-300 bg-[#6C2D2CD9] lg:text-black text-white font-[800] flex justify-center items-center text-center h-[28px]' onClick={() => updateStackOnclick(Number(element))}>
                        ...
                        <div className='hidden lg:flex justify-between items-center py-1.5 px-4'>
                            ...
                            <button className="bg-[#097c93] hover:bg-[#097c93]/90 flex justify-center items-center text-white text-[14px] px-2 py-1.5 h-[35px] w-[16%]"
                            ...
                            <div className="flex justify-end items-center space-x-2 w-full">
                                <button className="bg-[#FC4242] hover:bg-[#FC4242]/90 flex justify-center items-center text-white text-[14px] px-2 py-1.5 h-[35px] w-[16%]" onClick={() => handleClose()}>
                                    Reset
                                </button>
                                <button className="bg-[#0b7d36] hover:bg-[#0b7d36]/90 flex justify-center items-center text-white text-[14px] px-2 py-1.5 h-[35px] w-[16%]" onClick={() => placeBet()}>
                                    Submit
                                </button>
                            </div>
                        </div>
