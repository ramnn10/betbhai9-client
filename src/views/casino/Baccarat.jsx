                    ...
                    <div className=" pb-20 bg-black/5 mt-0.5">
                      ...
                      <div className="flex space-x-2 justify-end items-center py-1.5 px-2">
                        {result && result.length > 0 ? result.map((element, index) => (
                          <div key={index} onClick={() => this.handleResultModel(element)} className={`w-7 h-7 cursor-pointer flex justify-center items-center rounded-full shadow-sm ${element?.result === "1" ? "bg-[#086cb8] text-white" : element?.result === "2" ? "text-white bg-[#ae2130]" : element?.result === "3" ? "text-white bg-[#d0012f]" : "text-[#000]"}`}>
