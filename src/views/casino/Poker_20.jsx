...
function Poker_20({ eventId }) {
  ...
  const placeBet = async () => {
    ...
    let betObject = {
      ...
      "casinoType": state.shortName ? state.shortName : "poker20",
      "eventId": eventId,
                ...
                <div className="w-full lg:flex block">
                  <div className="lg:w-[70%] w-full bg-white">
                    ...
                    <div className="odds-bet">
                      ...
                      <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-5 gap-0 lg:pt-4 py-2">

                        <div className="text-[16px] tracking-normal px-2 dark-text font-[600] lg:py-0 py-2 lg:hidden block">Player A</div>
                        <div className="w-full space-y-2.5">
                          <div className="w-full">
                            <div className="grid grid-cols-3 space-x-2 px-1">
                              <BetButton
                                data={Winner1}
                          ...
                          <div className="w-full">
                            <div className="grid grid-cols-3 space-x-2 px-1">
                              ...
                              <BetButton
                                ...
                                handleBackOpen={handleBackOpen}
                                section1Ref={section1Ref}
                                name="Four of a Kind A" />

                              <BetButton
                                data={StraightFlush1}
                                handleBackOpen={handleBackOpen}
                                section1Ref={section1Ref}
                                name="Straight Flush A" />

                            </div>
                          </div>
                        </div>
                        <div className="text-[16px] tracking-normal px-2 dark-text font-[600] lg:py-0 py-2 lg:hidden block">Player B</div>
                        <div className="w-full space-y-2.5">
