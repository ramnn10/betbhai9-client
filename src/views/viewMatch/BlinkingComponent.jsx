...
const BlinkingComponent = ({ price, size, color }) => {
    ...
    return (
        ...
        <div className='text-center leading-3'>
            <span className="2xl:text-[16px] lg:text-[16px] text-xs text-black font-bold">{price ? price : "-"}</span><br />
            <span className="2xl:text-xs lg:text-[10px] text-black text-xs">{size ? size : null}</span>
        </div>
    </div>
    );
};
