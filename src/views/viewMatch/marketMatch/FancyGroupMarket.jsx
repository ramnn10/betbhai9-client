        ...
        {groupedData && Object.keys(groupedData).length > 0 &&
          Object.entries(groupedData).map(([sessionName, items], index) => (
            <div key={index} className="mb-4 overflow-hidden">
              ...
              {/* Min/Max */}
              <div className="grid grid-cols-3 gap-2 border-t text-sm">
                <div className="text-[11px] col-span-2  text-[teal] px-2 py-1 font-medium">
                  Min: 100 Max: 1L
                </div>
              ...
              {items.map((commList, i) => (
                <div key={i}>
                  <div
                    className="grid grid-cols-3 gap-2 border-t text-sm"
                  >
                    <div className="col-span-2 px-2">{i} Number</div>
                    <div
                      className="text-center  lg:bg-[#72bbef] bg-[#a7d8fd] text-black cursor-pointer"
                      onClick={() => {
